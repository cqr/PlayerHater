 ...
 ******************************************************************************/
package com.chrisrhoden.glisten.service;
...
import com.chrisrhoden.glisten.ipc.ClientPlugin;
...
import com.chrisrhoden.glisten.mediaplayer.PlaylistSupportingPlayer;
import com.chrisrhoden.glisten.plugins.BackgroundedPlugin;
import com.chrisrhoden.glisten.plugins.PluginCollection;
import com.chrisrhoden.glisten.service.PlayerStateWatcher.PlayerHaterStateListener;
...
public abstract class PlayerHaterService extends Service implements
    ...
    private MediaSessionCompat.Token mMediaSession;
    ...
    public void setTransportControlFlags(int transportControlFlags) {
        ...
        if ((PlayerHater.STATE_STREAMING & getState()) == 0) {
            mTransportControlFlags = mTransportControlFlags
    ...
    public void onDurationChanged(int duration) {
        getPlugin().onDurationChanged(duration);
    }
    ...
    public void setMediaSession(MediaSessionCompat.Token mediaSessionToken) {
        Log.d("SetMediaSession");
        Log.d("SetMediaSession");
        Log.d("SetMediaSession");
        Log.d("SetMediaSession");
        Log.d("SetMediaSession");
        Log.d("SetMediaSession");
        mMediaSession = mediaSessionToken;
    }
